...
# python3 ./tests/bench/evaluate.py --test-llvm --opt-level 1 --testcase-dir ./tests/small-test/
python3 ./tests/bench/evaluate.py --test-llvm --opt-level 1 --testcase-dir .tests/testcase/functional_test/Basic
